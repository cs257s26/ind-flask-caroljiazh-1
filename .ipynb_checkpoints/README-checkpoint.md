...
These three columns are the only ones that matter. Others like code, literacy rate, population, and region, are irrelevant. I chose VARCHAR for country names since they are text made our of letters, INTEGER for year since years are whole numbers, and FLOAT for avg_years_schooling since there are decimals. The primary key is the combination of country and year, since each country has one value per year.
